...
then
  ...
  docker-compose up $1 --scale $LB_STATIC_NAME=$LB_STATIC_NUM --scale $LB_SERVICE_NAME=$LB_SERVICE_NUM
  #docker-compose scale $LB_STATIC_NAME=$LB_STATIC_NUM $LB_SERVICE_NAME=$LB_SERVICE_NUM
